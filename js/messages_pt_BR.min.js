...
!(function (a) {
	...
	return (
		a.extend(a.validator.messages, {
			...
			require_from_group: a.validator.format(
				"Por favor, forne&ccedil;a pelo menos {0} destes campos."
			),
			skip_or_fill_minimum: a.validator.format(
			...
			ziprange:
				"O c&oacute;digo postal deve estar entre 902xx-xxxx e 905xx-xxxx.",
